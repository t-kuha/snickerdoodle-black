...
proc create_hier_cell_hdmi_audio { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hdmi_audio() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  set ETH0_CLK125 [ create_bd_port -dir I -type clk -freq_hz 125000000 ETH0_CLK125 ]
  set ETH1_CLK125 [ create_bd_port -dir I -type clk -freq_hz 125000000 ETH1_CLK125 ]
  set_property -dict [ list \
  ...
  set HDMI_RX_PCLK [ create_bd_port -dir I -type clk -freq_hz 148500000 HDMI_RX_PCLK ]
...
1#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#I2C 1#I2C 1#GPIO#GPIO#USB 0#USB 0#USB\
0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD\
0#SD 0#SPI 1#SPI 1#SPI 1#SPI 1#UART 0#UART 0#GPIO#GPIO} \
