...
################################################################
# This is a generated script based on design: sd_blk_axis_io
#
...
# source sd_blk_axis_io_script.tcl
...
set design_name sd_blk_axis_io
...
proc create_root_design { parentCell } {
  ...
  # Create instance: data_src_0, and set properties
  set data_src_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_counter_binary:12.0 data_src_0 ]
  set_property -dict [ list \
  ...
  # Create instance: psr_0, and set properties
  set psr_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_0 ]

  # Create instance: psr_1, and set properties
  set psr_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_1 ]

  # Create instance: stream_fifo, and set properties
  set stream_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 stream_fifo ]
  set_property -dict [ list \
  ...
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins data_src_0/Q] [get_bd_pins stream_fifo/s_axis_tdata]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins data_src_0/CLK] [get_bd_pins psr_0/slowest_sync_clk] [get_bd_pins stream_fifo/s_axis_aclk]
  connect_bd_net -net clk_wiz_clk_out2 [get_bd_pins clk_wiz/clk_out2] [get_bd_pins psr_1/slowest_sync_clk] [get_bd_pins stream_fifo/m_axis_aclk]
  connect_bd_net -net clk_wiz_locked [get_bd_pins clk_wiz/locked] [get_bd_pins psr_0/dcm_locked] [get_bd_pins psr_1/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins psr_0/peripheral_aresetn] [get_bd_pins stream_fifo/s_axis_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk_wiz/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins psr_0/ext_reset_in] [get_bd_pins psr_1/ext_reset_in]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins stream_fifo/s_axis_tvalid] [get_bd_pins xlconstant_0/dout]
  ...
  set_property PFM_NAME {vendor:lib:sd_blk_axis_io:1.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {clk_out2 {id "5" is_default "true" proc_sys_reset "/psr_1"}} [get_bd_cells /clk_wiz]
  ...
  set_property PFM.AXIS_PORT {M_AXIS {type "M_AXIS" sptag ""}} [get_bd_cells /stream_fifo]
  set_property PFM.IRQ {In0 {} In1 {} In2 {} In3 {} In4 {} In5 {} In6 {} In7 {} In8 {}} [get_bd_cells /xlconcat_0]
