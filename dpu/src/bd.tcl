...
################################################################
# This is a generated script based on design: sd_blk_dpu
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ps_rst_axi, and set properties
  set ps_rst_axi [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 ps_rst_axi ]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins dpu_eu_0/S_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins dpu_eu_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps_rst_axi/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins ps_rst_axi/ext_reset_in] [get_bd_pins ps_rst_dpu/ext_reset_in] [get_bd_pins ps_rst_dsp/ext_reset_in]
  connect_bd_net -net ps_rst_axi_peripheral_aresetn [get_bd_pins dpu_eu_0/s_axi_aresetn] [get_bd_pins ps_rst_axi/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net ps_rst_dpu_peripheral_reset [get_bd_pins dpu_eu_0/m_axi_dpu_aresetn] [get_bd_pins ps_rst_dpu/peripheral_aresetn]
